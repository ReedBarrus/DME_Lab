...
| Append Ledger | pressure-tested | Commit admitted envelopes as stable append-only records. | `src/ledger/jsonl.py`; `tests/replay/test_ledger_harness.py`; `traces/ledger_runtime_pressure_v0.json`; `docs/decisions/ledger_runtime_pressure_v0.md`; `traces/live_ingest_ledger_v0.jsonl`; `traces/live_vertical_probe_v0.json`; `traces/live_ingest_continuation_v0.json` | scale, serialization stability, single-writer assumption, amendment lookup |
